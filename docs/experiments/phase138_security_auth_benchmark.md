...
- **Run ID:** `phase138-security-auth-3b4170e83054a85c`
- **Model:** `fodci-security-auth-v1`
...
|---|---:|---:|---:|---:|
| jwt | 2 | 0.00% | 100.00% | 0.00% |
| middleware | 2 | 0.00% | 100.00% | 0.00% |
| oauth2 | 2 | 0.00% | 100.00% | 0.00% |
| password_hashing | 2 | 0.00% | 100.00% | 0.00% |
