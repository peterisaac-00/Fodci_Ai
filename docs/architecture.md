...
The approximately 26M scaling checkpoint remains an experimental artifact and is not activated. The final stable runtime remains CPU-compatible, zero-external-API, and based on the 11,424,400-parameter `fodci-testing-qa-v1` checkpoint.
