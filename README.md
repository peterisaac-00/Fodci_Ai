...
> **Current status: Phase 7.6 — Regression Protection; Phase 7.7 not started.**
...
| 7.6 | Regression Protection (`RegressionProtection`, `RegressionProtectionResult`); Phase 7.7 not started |
