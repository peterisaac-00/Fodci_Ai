...
> **Current status: Phase 6.5 — Execution Budgets & Limits; Phase 6.6 not started.**
...
| 6.5 | Centralized Execution Budgets (`ExecutionBudget`, `ExecutionUsage`, `ExecutionBudgetLedger`); Phase 6.6 not started |
