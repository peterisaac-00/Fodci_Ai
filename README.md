...
> **Current status: Phase 7.1 — Automatic Test Execution; Phase 7.2+ not started.**
...
| 7.1 | Automatic Test Execution (`AutomaticTestOrchestrator`, `AutomaticTestResult`); Phase 7.2+ not started |
