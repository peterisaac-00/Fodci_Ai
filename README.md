...
> **Current status: Phase 7.3 — Root Cause Analysis; Phase 7.4+ not started.**
...
| 7.3 | Root Cause Analysis (`RootCauseAnalyzer`, `RootCauseAnalysis`); Phase 7.4+ not started |
