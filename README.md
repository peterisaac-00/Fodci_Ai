...
> **Current status: Phase 7.4 — Automatic Fix; Phase 7.5+ not started.**
...
| 7.4 | Automatic Fix (`AutomaticFixPlanner`, `AutomaticFixOrchestrator`, `AutomaticFixResult`); Phase 7.5+ not started |
